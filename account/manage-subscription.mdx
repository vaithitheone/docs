...
<CardGroup cols={2}>
<Card title="Open Manage Subscription" icon="gear" href="https://gellerwash.test/app/manage-subscription">
Go to the subscription management screen.
</Card>

<Card title="Billing & invoices" icon="credit-card" href="https://gellerwash.test/app/billing-invoice">
...
- **Popup or redirect blocked**: Allow redirects for `gellerwash.test` and Razorpay domains.
</Accordion>
